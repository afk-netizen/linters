...
class Parking(db.Model):
    ...
    clients = db.relationship('Client', secondary='client_parking', back_populates='parking')
...
class Client(db.Model):
    ...
    parking = db.relationship('Parking', secondary='client_parking', back_populates='clients')
